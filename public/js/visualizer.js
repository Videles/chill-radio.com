...
function setupAudioApi(audioElement) {
	var src = audioContext.createMediaElementSource(audioElement); // C'est ce qui fait bug.
	// En fait createMediaElementSource permet de créer un audio manipulable, sauf que vu que c'est un stream ça marche pas.
